...
class MyCanvas extends Canvas {
    ...
    public void paint(Graphics g) {
        ...
        g.setColor(new Color(39, 32, 87));
        g.drawString("SOUTH", 495, 425);
        g.drawString("WEST", 503, 830);
        ...
        g.drawString("LOS ANGELES", 465, 845);
        ...
        int[] xValuesTeamsRight1 = {1460, 1496, 1438, 1455, 1435, 1457, 1455, 1458, 1465, 1460, 1455, 1453, 1455, 1462, 1467, 1430, 1465, 1470, 1450, 1467, 1463, 1430, 1465, 1455, 1480, 1485, 1445, 1460, 1445, 1450, 1478, 1478};
        
        int e = 0;
        while (e < 32){
            g.drawString(listNum[e], posx1 - 12, num);
            g.drawString(teamsRight1[e], xValuesTeamsRight1[e], num-2);
            g.drawLine(posx2, posy1, posx1, posy1);
            g.drawLine(posx2, posy1, posx2, posy2);
            g.drawString(listNum[e + 1], posx1 - 12, num2-2);
            g.drawString(teamsRight1[e + 1], xValuesTeamsRight1[e + 1], num2-2);
