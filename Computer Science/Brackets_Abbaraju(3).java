...
class MyCanvas extends Canvas {
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("W", 905, 195);
        g.drawString("MW", 1114, 195);
        g.setColor(Color.black);
        ...
        String[] teamsRight2 = {"Villanova 1", "Alabama 9", "West Virginia 5", "Marshall 13", "Florida 6", "Texas Tech 3", "Butler 10", "Purdue 2", "Kansas 1", "Seton Hall 8", "Clemson 5", "Auburn 4", "Syracuse 11", "Michigan St. 3", "Rhode Island 7", "Duke 2"};
